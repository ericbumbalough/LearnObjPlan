"""
Django settings for LearnObjPlan project.
...
ROOT_URLCONF = 'LearnObjPlan.urls'
...
WSGI_APPLICATION = 'LearnObjPlan.wsgi.application'
...
AUTH_USER_MODEL = 'LearnObjPlanApp.User'